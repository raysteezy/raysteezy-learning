...
and saves structured CSV/JSON files to data/planet-labs/.

Schedule: Weekly via GitHub Actions (no API key required)
...
def fetch_dataframe(df_raw, label):
    """Transpose and clean a yfinance financial statement DataFrame."""
